...
以下截图均来自真实 PlanPilot Desktop 窗口中的已登录 admin 学习空间，不再使用访客演示数据。空间内持久化了 3 个长期目标、15 份真实上传资料、19 篇笔记、4 组 Pilo 对话，以及历史、今日和宏观计划任务。用户和学习行为是为产品验证构造的长期样本；资料文件来自公开高校、考试机构与开源项目。
