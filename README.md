...
**PlanPilot｜AI 学习规划与执行工作台** · Electron / Next.js / Python / Docker

- 设计并实现目标—任务—知识—复盘闭环，支持 Pilo 展示判断依据、生成调整预览，并在用户确认后应用；
- 构建本地优先桌面运行时，通过合成体验数据完整演示多目标进度、真实投入、资料关联和可解释 AI 建议。
