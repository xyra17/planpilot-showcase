...
本目录按“产品定位 → 架构规格 → 阶段实施 → 产品体验 → 工程审计 → 运维部署 → 历史归档 → 产品战略研究”分类。真实代码和数据库迁移始终优先于历史设计文档；阶段完成报告用于说明对应时间点的实现状态。
...
| [08 产品战略与市场研究（2026-08）](./08_产品战略与市场研究_2026-08/README.md) | 五份核心文档：BRD/Roadmap、MRD/竞品、PRD/交互、研究/指标、智能行动运行手册 | [研究文档集入口](./08_产品战略与市场研究_2026-08/README.md) |
...
- 产品或业务背景：先读 `01_产品与项目`；需要当前战略、市场和智能行动责任链时，再读 `08_产品战略与市场研究_2026-08`。
