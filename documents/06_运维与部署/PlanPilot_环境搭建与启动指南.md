...
python -m mlx_lm server \
  --model /Users/yourname/Downloads/models/PlanPilot/lmstudio-community/Qwen3.5-9B-MLX-4bit \
...
模型路由和后续微调方案见
[`本地模型路由与微调路线.md`](../02_架构与技术规格/技术规格说明书/本地模型路由与微调路线.md)。
...
详细说明见
[`PlanPilot_模型供应商切换说明.md`](./PlanPilot_模型供应商切换说明.md)。
