...
**版本：** v2.0
**代码基准：** 2026-08-24 当前前端与 Agent API
...
目标可新建、编辑和查看详情；计划、任务和进度已有后端及页面能力。首登体验仍偏向展示完整产品表面。
...
| 目标 | 新增、编辑、详情、任务和计划 | 两周滚动计划的解释与确认 |
| 恢复 | 打卡、债务、改期、重规划分散存在 | 统一三档恢复体验 |
| 验收 | 后端与前台入口存在 | 按任务类型提供轻验收 |
