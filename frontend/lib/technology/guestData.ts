...
export const GUEST_RESOURCES = [
  ...
  { id: "guest-resource-writing", name: "晨间写作 30 天题目卡.md", type: "Markdown", library: "未归档", libraries: [], status: "处理中", processingStatus: "processing", updated: "刚刚", size: "7.5 KB", source: "sample", isDemo: true, goalIds: [], goalTitles: [], summary: "提供从感官观察、人物动作到观点展开的 30 个低门槛写作题目。", contentFormat: "markdown", content: "# 晨间写作题目卡\n\n1. 描写窗外最先吸引你的颜色\n2. 记录一次没有说出口的感谢\n3. 只用动作描写一个正在等待的人\n4. 为昨天的一个决定写下另一种可能\n\n规则：20 分钟内不停笔，先完成，再修改。" },
] as const;
