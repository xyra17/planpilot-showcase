...
export default function KBCreateDrawer({ open, onClose, onConfirm }: KBCreateDrawerProps) {
  ...
  return (
    <>
      ...
      <div role="dialog" aria-modal="true" aria-label="新建知识库" className="journal-dialog fixed top-0 right-0 h-full w-96 bg-white shadow-2xl z-50 flex flex-col">
        {/* 头部 */}
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div>
            ...
            <button
              ...
              className="w-full border border-dashed border-gray-300 rounded-lg py-2.5 text-xs text-gray-500 hover:border-blue-400 hover:text-blue-500 transition"
            >
              点击选择文件（PDF、TXT、MD…）
            </button>
            <input
